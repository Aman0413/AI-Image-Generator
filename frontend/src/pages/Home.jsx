...
function Home() {
  ...
  return (
    <>
      ...
      <div className="w-full flex flex-col justify-center items-center p-4 gap-6 mt-28 mb-10">
        ...
        <div className="w-[90%] flex flex-col justify-center gap-5 ">
          <div className="flex justify-between">
            <div className="card w-52 bg-base-100 shadow-[0_20px_50px_rgba(255,176,47,0.6)] bg-primary flex justify-center items-center p-5 rounded-lg">
      ...
      {/* contact us form end */}
      {/* footer start */}
      <section className=" w-full border-t-2 bg-white">
        <div className="w-[90%] px-4 py-12 mx-auto space-y-8 overflow-hidden sm:px-6 lg:px-8 ">
          ...
          <p className="mt-8 text-base leading-6 text-center text-gray-400 ">
            © {date} Generator, Inc. All rights reserved.
          </p>
        </div>
      </section>
      ;{/* footer end */}
